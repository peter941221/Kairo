...
sglang_wheel="${KAIRO_SGLANG_WHEEL:-${HOME}/kairo-packages/sglang-0.5.19-cp312-cp312-manylinux_2_34_x86_64.whl}"
...
printf '%s\n' "${KAIRO_GPU_VENV}/lib/python3.12/site-packages" \
